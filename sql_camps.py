...
while True:
    ...
    if os.path.isdir(campeonato):
        ...
        camp_name = input('Informe o nome do novo campeonato: ').capitalize().strip()
        confirme = ' '
...
\033[1mSua escolha:\033[m ''').strip()
        ...
        while c <= qnt_equipes:   # Equipes participantes
            if not os.path.isfile(camp_name+'/equipes.txt') and not os.path.isfile(camp_name[0:3]+'_equipes.txt'):
                ...
                print('\033[33mEquipes existentes\033[m'.center(44))
                print('*' * 40)
                ...
                if qnt_equipes == len(eqps):
                    with open(camp_name+'/equipes.txt', 'w') as a:
                        for c, eqp in enumerate(eqps):
                            a.write(eqp+'\n')
                            print(eqp.center(18), flush=True, end='' if c == 0 or c % 2 != 0 else '\n')
                            sleep(0.5)
                        print()
                    print('*' * 40)
                    sleep(2)
            ...
            c += 1
        os.system('clear')
        print(f'\n\033[32m{camp_name} {ano_hj} adicionado com sucesso!')
        sleep(3)
